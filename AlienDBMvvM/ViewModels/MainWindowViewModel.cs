...
public class MainWindowViewModel : ViewModelBase
{
    ...
    public MainWindowViewModel()
    {
        ...
        LoadData();
        var canShow = this
            .WhenAnyValue(vm => vm.SelectedFilm)
    ...
    private void LoadData()
    {
        ...
        {
            Films.Add(new FilmViewModel(model, item => Films.Remove(item)));
        }
        
}
    private void ShowDetails()
    {
        var filmVm = SelectedFilm;
        if(filmVm == null) return;
        
        var g = filmVm.Model;
        
        Console.WriteLine($"Film: {g.Title}");
    }
